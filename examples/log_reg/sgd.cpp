...
int main( int argc, char **argv )
{
  ...
  // solver type
  typedef stopt::LabeledAveragedParam<label_type,key_type,value_type> param_type;
  typedef stopt::SLLogReg< param_type, data_type > oracle_type;
  typedef stopt::SGD< oracle_type, param_type, data_type > solver_type;
  ...
  solver_type solver( opt.biased_f, opt.lambda, opt.eta, opt.t0, opt.order, opt.astart );
